<?php
ob_start();
define('API_KEY','5072527726:AAGDE4QiwlMF9eTDRuyn1g5XBukUwWtLZJY');
echo "api.telegram.org/bot".API_KEY."/setwebhook?url=".$_SERVER['MOON_HACK_PUBG']."".$_SERVER['MOON_HACK_PUBG'];
...
$Dev = array("5070844248","1932923228","3");
$usernamebot = "spider_man_10_BOT";
$channel = "M1_m2s";
$admin = 1729478411;
$channelcode = "1700570433"; // ايدي القناة الي ترسل بيها لهدايا
$token = API_KEY;
...
﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎﹎
[اضغط هنا وتابع جديدنا ، 📢](https://t.me/hack_lraq)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
